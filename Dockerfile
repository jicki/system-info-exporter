...
FROM reg.deeproute.ai/deeproute-public/zzh/cuda:12.4.1-devel-ubuntu22.04 AS builder
...
FROM reg.deeproute.ai/deeproute-public/zzh/cuda:12.4.1-base-ubuntu22.04
